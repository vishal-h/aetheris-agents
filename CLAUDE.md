...
`Source: m-docbuilder-m1 t4, t8; BL-007 t3; t1a rounds 1–3, 2026-08-06 (docs/reviews/t1a-review.md) — three channel failures in one ticket, the second of them reasoning its way into the failure while invoking the rule.`
