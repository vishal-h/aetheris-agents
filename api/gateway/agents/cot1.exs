...
%Aetheris.RunConfig{
  run_id:           "cot1-standalone-#{Aetheris.ID.generate()}",
  mode:             :record,
  provider:         "anthropic",
  ...
  """,
  user_prompt: "Wait for the TAP intent, validate it, execute against ct-api, write the result, and notify at1qry. Begin."
}
