...
> **[Appended 2026-09-15, BL-253.]** Until the split, the manifest header's **Kernel budget**
> paragraph carried this boundary's first budget measurement. It moved here, and the header now
> states a current figure. Below are whole lines 29–32 of the header at `1592c95`, verbatim, so the
> trailing `Reproduce:` comes with them:
