...
| `rig--runbook.md` | `docs/rig/runbook.md` | aetheris-agents | `caab177` | 2026-06-25 |
...
| `capability-matrix.md` | `docs/capability-matrix.md` | aetheris-agents | `caab177` | 2026-06-25 |
...
| `project-knowledge-manifest.md` | `docs/project-knowledge-manifest.md` | aetheris-agents | _(this export)_ | 2026-06-25 |

---

Exported: 2026-06-25 at aetheris-agents `caab177` / aetheris `1a8eb08`.
