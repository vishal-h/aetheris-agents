...
3. `../aetheris/docs/… specs §6` — document the field in the event-schema table (drift_check
   enforces §6 ↔ `event.ex`).
...
> Trajectory.File map + specs §6. Back-compat test: pre-existing trajectory file without the
